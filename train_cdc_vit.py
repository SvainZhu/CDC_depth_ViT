...
from models.cdc_vit_model import vit_base_patch16_224, vit_base_patch32_224
...
if __name__ == '__main__':
    ...
    train_set, valid_set = Dataset_Csv(train_list, train_label, transform=vit_transforms), \
                           Dataset_Csv(test_list, test_label, transform=vit_transforms)
